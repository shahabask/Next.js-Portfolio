...
function EmailSection() {
  ...
  return (
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative' id='contact'>
       <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-sky-600 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-1/2'></div>
        <div className='z-10'>
          ...
          <p className="text-green-500 text-sm mt-2">
            ...
            <form className='flex flex-col gap-6' onSubmit={handleSubmit}>
                ...
                <div className='mb-6'>
                    ...
                    placeholder="Let's talks about..."
                    className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5'
                    />
                </div>
                <button type='submit'
                className='bg-sky-500 hover:bg-sky-400 text-white font-medium py-2.5 px-5 rounded-lg w-full'
                >
              Send Message
                </button>
            </form> )}
